...
const L = { ar: {
 ...
 roomCapNote:"أقصى مدة للحجز الواحد ساعتين — تقدر تحجز أكتر من قاعة في نفس اليوم.",roomDefaultSubject:"اجتماع",bookRoom:"احجز قاعة",date:"التاريخ",
 ...
 roomCapNote:"Maximum 2 hours per booking — you can book more than one room the same day.",roomDefaultSubject:"Meeting",bookRoom:"Book a room",date:"Date",
