-- ══════════════════════════════════════════════════════════════
--  خيار النعناع لأي صنف — بنفس طريقة خيار اللبن بالظبط
-- ══════════════════════════════════════════════════════════════

alter table menu_items add column if not exists has_mint boolean default false;
alter table order_items add column if not exists mint boolean;

-- تحديث تذكرة البوفيه عشان تعرض النعناع كمان (نفس شكل اللبن)
